...
import { makePlanetTexture, makeCloudTexture, makeRingTexture, makeMarkerTexture, makeReticleTexture } from './textures.js?v=9';
import { ownerColor, NEUTRAL } from './constants.js?v=9';
