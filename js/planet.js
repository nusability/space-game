...
import { makePlanetTexture, makeCloudTexture, makeRingTexture, makeMarkerTexture, makeReticleTexture } from './textures.js?v=10';
import { ownerColor, NEUTRAL } from './constants.js?v=10';
